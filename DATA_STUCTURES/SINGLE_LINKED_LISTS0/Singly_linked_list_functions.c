...
int main(){
    ...
    while(1){
        ...
        printf("11:peek\n");
        printf("12:insertion_sort\n");
        scanf("%d", &choice);
        switch(choice){
            case 1:append();break;
            case 2:print_all();break;
            case 3:printf("length :%d\n\n", len(root));break;
            case 4:add_at_begining();break;
            case 5:delete_at_position(3);break;
            case 6:delete_fornt();break;
            case 7:add_at_position(3);break;
            case 8:swap_data(2, 5);break;
            case 9:reverse_list();break;
            case 10:sort_bubble(root);break;
            case 11:printf("peeked value at pos. 3:%d\n\n", peek(3));break;
            case 12:insertion_sort(root);break;
